#ifndef MPCINCMTXOPS_H
#define MPCINCMTXOPS_H
...
extern void mpcinc_mtx_multiply_mtx_mtx(real_t pout[], const real_t pmtxA[],
        const real_t pmtxB[],
...
extern void mpcinc_mtx_multiply_mtx_vec(real_t pout[], const real_t pmtx[],
        const real_t pvec[],
        const uint32_t rows,
        const uint32_t cols);
 ...
 * pmtx has size (rows x columns) */
extern void mpcinc_mtx_scale(real_t pout[], const real_t pmtx[],
...
extern void mpcinc_mtx_shift_sequence(real_t outseq[],
