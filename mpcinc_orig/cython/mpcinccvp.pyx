...
cdef class Former:
    ...
    def initialize(self, data, fname='data.json'):
        ...
        cdef Ccvp.mpcinc_cvp_prb *cprb = ccvp.prb
        cdef Ccvp.mpcinc_term *H = cprb.H
        cdef Ccvp.mpcinc_term *g = cprb.g
        cdef Ccvp.mpcinc_term *u_lb = cprb.u_lb
        cdef Ccvp.mpcinc_term *u_ub = cprb.u_ub
        self.prb = Prb(
    ...
    def form_problem(self, pardata):
        ...
        Ccvp.mpcinc_cvp_form_problem(ccvp)
