...
former-test: test_former.o hhmpcipm.o cjson.o hhmpcdynmem.o hhmpcipmdynmem.o hhmpcsolve.o hhmpcmath.o hhmpcusefull.o mpcincmtxops.o
	gcc -o ./tests/former-test hhmpcipm.o cjson.o hhmpcdynmem.o hhmpcipmdynmem.o hhmpcsolve.o hhmpcmath.o hhmpcusefull.o mpcincmtxops.o ./tests/test_former.o -lcheck -lpthread -lrt -lm
